...
var plugin = (function() {
  ...
  jsPsych.pluginAPI.registerPreload(
    "callback-image-keyboard-response",
    "stimulus",
    "image"
  );

  plugin.info = {
    name: "callback-image-keyboard-response",
    description: "",
    parameters: {
      stimulus: {
  ...
  plugin.trial = function(display_element, trial) {
    var new_html =
      '<img src="' +
      trial.stimulus +
      '" id="jspsych-callback-image-keyboard-response-stimulus"></img>';
    ...
    var after_response = function(info) {
      ...
      display_element.querySelector(
        "#jspsych-callback-image-keyboard-response-stimulus"
      ).className +=
        " responded";
